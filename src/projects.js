module.exports = {
  deconstruct: {
    ...
    description: 'Tote bag cred beard freegan, poke health goth hoodie. Wolf banjo occupy, microdosing post-ironic mumblecore wayfarers prism hella live-edge hoodie marfa. Hammock kale chips poutine, prism PBR&B vice polaroid cornhole schlitz glossier. Tumblr artisan tumeric, marfa fap migas pug leggings truffaut unicorn yuccie stumptown sartorial. Pabst try-hard twee small batch hammock. Roof party normcore narwhal 8-bit, dreamcatcher stumptown seitan authentic chartreuse pinterest. Occupy fanny pack crucifix, asymmetrical tofu +1 deep v lo-fi offal.',
